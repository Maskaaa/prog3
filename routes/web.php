...
//rotas de crud imagens
Route::get('imagens', [ImagensController::class, 'index'])->middleware(['verified'])->name('imagens');

Route::get('/imagens/inserir', [ImagensController::class, 'create'])->name('imagens.inserir');

Route::post('/imagens/inserir', [ImagensController::class, 'insert'])->name('imagens.gravar');

Route::get('/imagens/{img}', [ImagensController::class, 'show'])->name('imagens.show');

Route::get('/imagens/{img}/editar', [ImagensController::class, 'edit'])->name('imagens.edit');

Route::put('/imagens/{img}/editar', [ImagensController::class, 'update'])->name('imagens.update');

Route::get('/imagens/{img}/apagar', [ImagensController::class, 'remove'])->name('imagens.remove');

Route::delete('/imagens/{img}/apagar', [ImagensController::class, 'delete'])->name('imagens.delete');
